package com.example.everton.mediaapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clique(View view) {
        ...
        if (nota1.getText().length() > 0 && nota2.getText().length() > 0) {
            ...
            String Tnota1 = nota1.getText().toString();
            String Tnota2 = nota2.getText().toString();

            float n1 = Float.valueOf(Tnota1);
            float n2 = Float.valueOf(Tnota2);
            float m = (n1 + n2) / 2;

            String Tmedia = String.valueOf(m);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.everton.mediaapp/http/host/path")
        );
